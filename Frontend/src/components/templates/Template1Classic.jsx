// Template 1: Classic Professional - Original Design
import { BASE_URL } from '../../config/api';
import { getBusinessType } from '../../utils/businessTypes';
import './CardTemplates.css';

const Template1Classic = ({ cardData }) => {
  ...
  return (
    <div className="template-card template-classic">
      <div className="template-bg" style={{ 
        backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCPpe-k84toSEGhhJNUDPW83hE_2pJF50lf_563UX6935jp8sSuhF7bWda8JnhkWdjR8uJLz-Y2rPZaZDDaM0qzY2vxW4hm3Gw3SiKY9TC-Lvzum0Bzqb0M62T_v-Rvi2KyZ1_tqX0YUxRQ8bYMyxGGE3RGCZNksqHNTRUZjQ9UMz7UDPIMRXmZXG7B_DmtJKKJw0r6wZAVlgcUKfOdR1oxXOdyTIwtdLLbNoq_SQ0LRCed3FfGAoMt3o7qjHR244PobAMHIF7KvK4O")',
      ...
      <div className="template-content classic-original-content">
        <div className="classic-original-header">
          <div className="classic-original-profile-section">
            {imageUrl ? (
              <div className="classic-original-profile-img">
                <img src={imageUrl} alt={name} />
              </div>
            ) : (
              <div className="classic-original-profile-placeholder">
                <span className="material-symbols-outlined">person</span>
              </div>
            )}
            <div className="classic-original-info">
        ...
        {bio && (
          <div className="classic-original-bio-section">
