...
const Template3Modern = ({ cardData }) => {
  ...
  return (
    <div className="template-card template-modern">
      <div className="template-bg modern-bg">
        <div className="modern-diagonal" style={{ background: `linear-gradient(135deg, ${themeColor}15 0%, transparent 100%)` }}></div>
        <div className="template-overlay"></div>
      </div>
      
      <div className="template-content modern-content">
        {/* Top Left - Profile & Name */}
        <div className="modern-header">
          {imageUrl ? (
            <div className="modern-profile-img">
              <img src={imageUrl} alt={name} />
            </div>
          ) : (
            <div className="modern-profile-placeholder" style={{ background: `linear-gradient(135deg, ${themeColor}, ${themeColor}dd)` }}>
        ...
        {/* Bio */}
        {bio && (
          <div className="modern-bio">
            <p className="template-bio">{bio}</p>
          </div>
        )}

        {/* Bottom Right - Social Grid */}
...
export default Template3Modern;
